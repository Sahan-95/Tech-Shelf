...
class _ApiClient implements ApiClient {
  ...
  Future<BookSearchResponse> searchBooks(String query) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<BookSearchResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<NewReleasesResponse> getNewReleases() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NewReleasesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NewReleasesResponse.fromJson(_result.data!);
    return value;
  }
